...
for (let drink of drinks) {
    ...
    if (drink.type == "wine") {
        let wineRow = <HTMLSelectElement>document.getElementById("wine");
        wineRow.innerHTML += result;
    } else if (drink.type == "beer") {
        let beerRow = <HTMLSelectElement>document.getElementById("beer");
        beerRow.innerHTML += result;

    } else if (drink.type == "shots") {
        let shotRow = <HTMLSelectElement>document.getElementById("shots");
        shotRow.innerHTML += result;
    } else if (drink.type == "mix") {
        let mixRow = <HTMLSelectElement>document.getElementById("mix");
        mixRow.innerHTML += result;
    } else if (drink.type == "non-alcohol") {
        let noAlcRow = <HTMLSelectElement>document.getElementById("non-alcohol");
        noAlcRow.innerHTML += result;
    } else {
        let coffeRow = <HTMLSelectElement>document.getElementById("coffeTea");
